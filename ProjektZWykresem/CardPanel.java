...
public class CardPanel extends JPanel {
    ...
    private static final String[] countries = new String[]{"Swiat", "Niemcy", "Rosja", "Polska", "Slowacja", "USA", "Brazylia", "Hiszpania", "UK", "Wlochy", "Francja", "Turcja", "Indie", "Iran", "Kanada", "Chiny", "Chile"};
    private static final String[] countriesURL = new String[]{"world", "germany", "russia", "poland", "slovakia", "us", "brazil", "spain", "uk", "italy", "france", "turkey", "india", "iran", "canada", "china", "chile"};
